    ...
    <el-aside :width="isCollapse ? '64px' : '200px'">
      ...
      >
        ...
        <el-submenu index="1">
          ...
          <!--二级菜单2-->
          <el-menu-item index="/routeplanmanual">
            <template slot="title">
        ...
        <el-submenu index="3">
          ...
          <!--二级菜单-->
          <el-menu-item index="/adupdatepwd">
            <template slot="title">
    ...
    <el-container>
      ...
      <el-header>
        ...
        <div>
          ...
          <span id="useracc" style="font-size:15px;">欢迎您，{{username}}！</span>
          <el-avatar
            :size="30"
...
export default {
  ...
  created() {
    ...
    //   this.$router.push("/login");
    // }
     this.username = this.$session.get("adminname");
     this.useracc = this.$session.get("adminaccount");
     this.userpwd = this.$session.get("adminpassword");
  }
};
</script>
